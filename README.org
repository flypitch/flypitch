...
* Compilation
To compile some parts of the Flypitch project, you will need a compiled copy of src_{mathlib} on your marchine. After cloning the repository to src_{flypitch}, navigate to src_{flypitch} and run
#+BEGIN_SRC
